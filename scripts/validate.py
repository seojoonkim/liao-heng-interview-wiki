...
OG_IMAGE = ROOT / "assets" / "og-liao-heng-right-type-v5.jpg"
OG_LAYOUT = ROOT / "assets" / "og-liao-heng-right-type-v5.json"
SITE_URL = "https://liao-heng-interview-wiki.vercel.app/"
OG_IMAGE_URL = f"{SITE_URL}assets/og-liao-heng-right-type-v5.jpg"
...
try:
    ...
    require(layout.get("font_sizes") == [35, 86, 38, 38, 24], "OG 전체 글자 크기 확대 계약 오류")
